...
@interface Gover_Zachary_AVF_WK3Object : KrollCoverageObject {
#else
@interface Gover_Zachary_AVF_WK3Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_AVF_WK3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_AVF_WK3Object *_gover_zachary_avf_wk3;
    KrollObject* console;
	BOOL shutdown;
