...
// in simulator we redefine to format for Gover_Zachary_AVF_WK3 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_avf_wk3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_avf_wk3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_AVF_WK3NativeItemNone = -1, 
	UIGover_Zachary_AVF_WK3NativeItemSpinner = -2,
	UIGover_Zachary_AVF_WK3NativeItemProgressBar = -3,
	
	UIGover_Zachary_AVF_WK3NativeItemSlider = -4,
	UIGover_Zachary_AVF_WK3NativeItemSwitch = -5,
	UIGover_Zachary_AVF_WK3NativeItemMultiButton = -6,
	UIGover_Zachary_AVF_WK3NativeItemSegmented = -7,
	
	UIGover_Zachary_AVF_WK3NativeItemTextView = -8,
	UIGover_Zachary_AVF_WK3NativeItemTextField = -9,
	UIGover_Zachary_AVF_WK3NativeItemSearchBar = -10,
	
	UIGover_Zachary_AVF_WK3NativeItemPicker = -11,
	UIGover_Zachary_AVF_WK3NativeItemDatePicker = -12,
	
	UIGover_Zachary_AVF_WK3NativeItemInfoLight = -13,
	UIGover_Zachary_AVF_WK3NativeItemInfoDark = -14,
	
	UIGover_Zachary_AVF_WK3NativeItemDisclosure = -15,
	
	UIGover_Zachary_AVF_WK3NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_AVF_WK3 instances of
