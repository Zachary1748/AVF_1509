...
//@interface Gover_Zachary_AVF_WK3Object : NSObject
//@end

@interface Gover_Zachary_AVF_WK3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Gover_Zachary_AVF_WK3Object class]])
		{
			for (NSString *key in [[(Gover_Zachary_AVF_WK3Object*)o modules] allKeys])
			{
