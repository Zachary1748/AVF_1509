...
NSString * const TI_APPLICATION_ID = @"com.zacharygover.wk1";
NSString * const TI_APPLICATION_PUBLISHER = @"Zachary";
NSString * const TI_APPLICATION_URL = @"http://";
NSString * const TI_APPLICATION_NAME = @"Gover_Zachary_AVF_WK1";
NSString * const TI_APPLICATION_VERSION = @"1.0";
NSString * const TI_APPLICATION_DESCRIPTION = @"undefined";
NSString * const TI_APPLICATION_COPYRIGHT = @"2015 by Zachary";
NSString * const TI_APPLICATION_GUID = @"e2c5fdbc-e307-4a16-9666-a26bee3081de";
