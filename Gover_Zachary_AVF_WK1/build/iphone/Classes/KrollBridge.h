...
@interface Gover_Zachary_AVF_WK1Object : KrollCoverageObject {
#else
@interface Gover_Zachary_AVF_WK1Object : KrollObject {
#endif
@private
...
extern NSString * Gover_Zachary_AVF_WK1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Gover_Zachary_AVF_WK1Object *_gover_zachary_avf_wk1;
    KrollObject* console;
	BOOL shutdown;
