...
//@interface Gover_Zachary_AVF_WK1Object : NSObject
//@end

@interface Gover_Zachary_AVF_WK1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Gover_Zachary_AVF_WK1Object class]])
		{
			for (NSString *key in [[(Gover_Zachary_AVF_WK1Object*)o modules] allKeys])
			{
