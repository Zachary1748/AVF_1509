...
// in simulator we redefine to format for Gover_Zachary_AVF_WK1 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_avf_wk1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_avf_wk1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_AVF_WK1NativeItemNone = -1, 
	UIGover_Zachary_AVF_WK1NativeItemSpinner = -2,
	UIGover_Zachary_AVF_WK1NativeItemProgressBar = -3,
	
	UIGover_Zachary_AVF_WK1NativeItemSlider = -4,
	UIGover_Zachary_AVF_WK1NativeItemSwitch = -5,
	UIGover_Zachary_AVF_WK1NativeItemMultiButton = -6,
	UIGover_Zachary_AVF_WK1NativeItemSegmented = -7,
	
	UIGover_Zachary_AVF_WK1NativeItemTextView = -8,
	UIGover_Zachary_AVF_WK1NativeItemTextField = -9,
	UIGover_Zachary_AVF_WK1NativeItemSearchBar = -10,
	
	UIGover_Zachary_AVF_WK1NativeItemPicker = -11,
	UIGover_Zachary_AVF_WK1NativeItemDatePicker = -12,
	
	UIGover_Zachary_AVF_WK1NativeItemInfoLight = -13,
	UIGover_Zachary_AVF_WK1NativeItemInfoDark = -14,
	
	UIGover_Zachary_AVF_WK1NativeItemDisclosure = -15,
	
	UIGover_Zachary_AVF_WK1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_AVF_WK1 instances of
