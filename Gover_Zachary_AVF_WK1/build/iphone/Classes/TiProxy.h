...
//Rare exceptions to indicate a bug in the _gover_zachary_avf_wk1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Gover_Zachary_AVF_WK1 proxies.
 */
